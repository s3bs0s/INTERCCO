                                        ...
                                        <% } else { %>
                                            <td>
                                                <div class="td-espaciado">
                                                    ...
                                                    <button type="button" class="btn btn-danger" onClick="proveedorEliminarModal('<%= session.getAttribute("genUsuario") %>', '<%= prov.getIdProveedores()%>', '<%= cA.CifrarASCII(prov.getNombreCoe())%>')"><span class="glyphicon glyphicon-remove"></span> Eliminar</button>
                                                </div>
                                            </td>
                                        <% } %>
                                    </tr>
