...
<html>
    ...
    <body>
        <div style="font-family:Arial; width:90%; margin:auto; padding:10px; border-radius:15px; background:#C1D0E7; "><div style="width:100%; "><div style="width:100%; padding:12px 0; background:#446EB6; border-top-left-radius:18px; border-top-right-radius:18px; "><a target="_blank" href="https://www.google.com/" style="width:30%; display:inline-block; margin-left:30px; "><img alt="FSUCCO" style="width:100%; " src="https://i.imgur.com/u2GoMPN.png"></a></div>
        <%  int eleccion = 6;
            if (eleccion == 1){ %>
