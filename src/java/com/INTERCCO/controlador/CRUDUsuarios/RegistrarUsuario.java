        ...
        try {
            ...
            if (rs.next()){
                if (rol == null){
                    ...
                    System.out.println("ERROR de REGISTRAR el dato de USUARIO1.");
                } else {
                ...
                if (rs.next()){
                    if (rol == null){
                        ...
                        System.out.println("ERROR de REGISTRAR el dato de USUARIO2.");
                    } else {
                    ...
                    if (res > 0){
                        ...
                        if (rs.next()){
                            ...
                            if (res2 > 0){
                                ...
                                if (rol == null){
                                    ...
                                    System.out.println("ERROR de REGISTRAR el dato de USUARIO3.");
                                } else {
                            ...
                            if (rol == null){
                                request.getRequestDispatcher("index?mensaje=Ne").forward(request, response);
                                System.out.println("ERROR de REGISTRAR el dato de USUARIO4.");
                            } else {
                                request.getRequestDispatcher("Usuarios?mensaje=Ne&nomusu="+nombres).forward(request, response);
                                System.out.println("ERROR de REGISTRAR el dato de USUARIO.");
                            }
                        ...
                        if (rol == null){
                            request.getRequestDispatcher("index?mensaje=Ne").forward(request, response);
                            System.out.println("ERROR de REGISTRAR el dato de USUARIO5.");
                        } else {
                            request.getRequestDispatcher("Usuarios?mensaje=Ne&nomusu="+nombres).forward(request, response);
                            System.out.println("ERROR de REGISTRAR el dato de USUARIO.");
                        }
