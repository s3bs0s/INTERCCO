...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `idCliente_pedidos` FOREIGN KEY (`idCliente`) REFERENCES `info_usuarios` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `idMeseroODomiciliario_pedidos` FOREIGN KEY (`idMeseroODomiciliario`) REFERENCES `info_usuarios` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
